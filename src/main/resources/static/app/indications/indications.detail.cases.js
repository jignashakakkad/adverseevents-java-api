 ...
 */
angular.module('indications').controller('IndicationsCasesCtrl', function ($scope, $filter, $state, $debounce, $stateParams, utilService, Cases, Restangular) {
    $scope.caseFilter = {
        dateLimit: '',
        outcomes: [{"outc_cod": "1"},{"outc_cod": 'OT'},{"outc_cod":'HO'},{"outc_cod":'DE'},{"outc_cod":'LT'},{"outc_cod":'RI'},{"outc_cod":'NS'},{"outc_cod":'CA'}],
        caseLimit: 10,
        selectedSource: "1",
        selectedGender: "1",
        selectedOccp: "1",
