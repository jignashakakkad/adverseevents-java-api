angular.module('indications').controller('IndicationsOverviewCtrl', function ($scope, $filter, Indication, Metrics, Regulatory, Restangular, Timeline) {

    $scope.Indication = Restangular.copy(Indication[0]);
    $scope.Metrics = Restangular.copy(Metrics[0]);
    $scope.Timeline = Timeline;

    $scope.indicationsArray = _.toArray(Indication[0].indications);
