(function () {
  'use strict';
    ...
    angular
    .module('company')
    .factory('companyRxsignalService' , ['$http', '$window', '$state', 'companyRxsignalGridService', 'localStorageService', companyRxsignalService]);

    function companyRxsignalService($http, $window, $state, companyRxsignalGridService, localStorageService) {
        ...
        function getCustomGridColumns(stateName) {
            ...
            if (!gridColumns) {
                gridColumns = companyRxsignalGridService.getColDefs('detail');
