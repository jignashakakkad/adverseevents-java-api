(function () {
  'use strict';
    ...
    angular
    .module('company')
    .factory('companyOutcomesService' , ['$window', '$state', 'localStorageService', companyOutcomesService]);

    function companyOutcomesService($window, $state, localStorageService) {
